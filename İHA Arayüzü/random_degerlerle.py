...
# a = vehicle.velocity ### burda x y z eksenleri olabilir teste göre ayarlıcaz

# b = vehicle.gimbal  ## roll değeri ile yapılacak roll komutu emin olmamakla birlikte bu komut

# c = vehicle.attitude ## teste göre katsayı ayarlıcaz

# d = vehicle.heading  ## 0 ila 360 arası veriyor pusulaya göre ayarlancak

# e =vehicle.heading  ## drone yönünü gösteriyor yukarıyla aynı olacak

# f =vehicle.location.global_relative_frame  ## irtifa olarak veriyor değerine bakıp açı kat sayısına evrilecek

a = random.randint(220,260)
b = random.randint(320, 340)
c = random.randint(0, 50)
d = random.randint(0, 180)
e = random.randint(320, 340)
f = random.randint(350, 360)
...
class Ui_MainWindow(QtWidgets.QWidget):
    def setupUi(self, MainWindow):
        ...
        self.btn_baglan = QtWidgets.QPushButton(self.centralwidget)
        self.btn_baglan.setGeometry(QtCore.QRect(1150, 40, 100, 25))
        self.btn_baglan.setStyleSheet("background-color: rgb(114, 159, 207);")
...
"")
        ...
        self.volt.setProperty("intValue", 15.8)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_baglan.setText(_translate("MainWindow", "BAGLAN"))
...
class WidgetUpdater(QtCore.QObject):
    ...
    def run(self):
        ...
        while True:
            #a = vehicle.velocity  *20 ### burda x y z eksenleri olabilir teste göre ayarlıcaz


            #b = vehicle.gimbal._vehicle._roll *15 ## roll değeri ile yapılacak roll komutu emin olmamakla birlikte bu komut

           # c = vehicle.attitude.yaw *10  ## teste göre katsayı ayarlıcaz
           ...
           #e =vehicle.heading      ## drone yönünü gösteriyor yukarıyla aynı olacak
            ...
            #f =vehicle.location.global_relative_frame.alt   *10 ## irtifa olarak veriyor değerine bakıp açı kat sayısına evrilecek    
            ...
            e = random.randint(320, 340)
            f = random.randint(350, 360)
            #v = random.randint(15, 17)

            self.updateWidgetsSignal.emit([a,b,c,d,e,f])
            time.sleep(0.8)
